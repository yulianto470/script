...
# set repo
wget -O /etc/apt/sources.list "http://script.jualssh.com/autoscript/conf/sources.list.debian6"
...
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "http://script.jualssh.com/autoscript/conf/1194.conf"
...
curl "http://script.jualssh.com/autoscript/conf/mrtg.conf" >> /etc/mrtg.cfg
...
wget -O /etc/squid/squid.conf "http://script.jualssh.com/autoscript/conf/squid.conf"
